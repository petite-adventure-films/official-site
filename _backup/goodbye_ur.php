	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<?php
						parse_post('goodbye_ur');
						DisplayScreenings(SCR_USER_FUTURE_FILM_SPECIFIC,'ur');						
					?>	
				</div>
				<!-- end #content -->
				<div id="sidebar">
					<ul>
						<li>
							...
							<hr/>
							<?php
								MenuBar('goodbye_ur',GBUR_MENU);
								parse_post('goodbye_ur_sidebar');
							?>
						</li>
					</ul>
				</div>
