...
<template>
  ...
  >
    <div class="flex justify-center gap-4">
      ...
      <NuxtLink
        to="https://www.youtube.com/user/petiteadventurefilms"
        target="_blank"
        rel="noopener noreferrer"
        class="block h-4"
      >
      ...
      ></NuxtLink>
      <NuxtLink
        to="https://en.petiteadventurefilms.com/"
        target="_blank"
        rel="noopener noreferrer"
        class="block text-xs sm:hover:text-gray-500"
        >🌐 EN</NuxtLink
    ...
    <ul class="flex flex-wrap justify-center gap-x-8 gap-y-2 mt-8">
      <li>
        <NuxtLink to="/specified-commercial-transaction-law/"
          >特定商取引法に基づく表記</NuxtLink
        >
      </li>
      <li>
        <NuxtLink to="/copyrights-disclaimers/"
          >サイトのご利用について</NuxtLink
        >
      </li>
      <li>
        <NuxtLink to="/gathering-the-personal-information/"
          >個人情報の扱いについて</NuxtLink
        >
      </li>
      <li><NuxtLink to="/privacy-policy/">プライバシーポリシー</NuxtLink></li>
      <li><NuxtLink to="/system-requirements/">推奨環境</NuxtLink></li>
