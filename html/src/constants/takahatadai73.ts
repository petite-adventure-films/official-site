...
export const urTimeline = [
  ...
  },
  {
    ...
    name: '住宅・都市整備公団',
    description:
      '全国各地に団地建設<br>ニュータウンの計画や建設<br>都市再開発事業',
  },
  {
    year: 1991,
    logo: 'ur_logo_3.png',
        ...
        events: [
          {
            day: 28,
            residents:
              '支援団体ら、「73号棟問題から公営公共住宅を考える集い」を日野市内で開催',
          },
        ],
      },
      2: {
      ...
      5: {
        ...
        events: [
          ...
          },
          {
            day: 17,
            residents:
              '第9回裁判。住民側、第6準備書面提出。URの社会的使命を指摘。MK意見陳述',
          },
        ],
      },
      7: {
        ...
        events: [
          {
            day: 10,
            residents:
              '住民側控訴。同時に、立ち退き強制執行停止申し立て（18日執行停止決定）',
          },
        ],
      },
      6: {
...
export const residents: {
...
}[] = [
  {
    ...
    notice:
      '中川京子さんは、2018年3月にお亡くなりになりました。ご冥福をお祈りいたします。',
    hobby: '小唄､義太夫､謡曲',
    favouriteIndex: '言葉',
  ...
  },
  {
    ...
    name: '村田英法',
    message:
      '定年になったら晴耕雨読を夢見ていたのに…。<br>でもこれも人生！楽しまなきゃね！！',
  ...
  },
  {
    ...
    name: '村田公子',
    message:
      '戦争のない世界､格差のない社会､憲法を守って戦争で生命を脅かされることのないように。',
  ...
  },
  {
    ...
    name: '畦地豊彦さん',
    notice:
      '畦地豊彦さんは2012年1月27日に亡くなられました。享年68歳。心よりご冥福をお祈りします。',
    hobby: '',
    favouriteIndex: '',
    favouriteContents: '',
    karaoke: '',
