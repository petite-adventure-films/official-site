...
<div class="form_contents required">
	...
	<div class="form_elements">
		<input type="text" name="contact_name" id="contact_name" value="<?php echo ($contact_name) ? $contact_name : ""; ?>" placeholder="e.g. Yamada Hanako"<?php echo $disabled; ?> />
	</div>
</div>
...
<div class="form_contents required">
	...
	<div class="form_elements">
		<input type="email" name="contact_email" id="contact_email" placeholder="e.g. abc@example.com" value="<?php echo ($contact_email) ? $contact_email : ""; ?>"<?php echo $disabled; ?> />
	</div>
</div>
<div class="form_contents required" id="contact_email_confirm_form">
	...
	<div class="form_elements">
		<input type="email" name="contact_email_confirm" id="contact_email_confirm" placeholder="e.g. abc@example.com" onpaste="return false" value="<?php echo ($contact_email_confirm) ? $contact_email_confirm : ""; ?>"<?php echo $disabled; ?> />
	</div>
</div>
</div>
