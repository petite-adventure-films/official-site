...
<div class="form_contents required" id="pick_dvd">
	...
	<ul class="form_elements">
		<li>
			<p class="bold">My Indian Diary - The Women of the Banyan Tree</p>
			<p>For Home: JP ¥3,000 / For Library: JP ¥10,000</p>
			<label for="contact_film7_kind">Type</label>
			<select name="contact_film7_kind" class="contact_film_kind" id="contact_film7_kind"<?php echo $disabled; ?>>
				...
				<option value="1"<?php echo ($contact_film7_kind == 1) ? " selected" : ""; ?>>Home</option>
				<option value="2"<?php echo ($contact_film7_kind == 2) ? " selected" : "";?>>Library</option>
			</select>
			<label for="contact_film7_unit">Quantity</label>
