...
<div class="col col_6 last">
    ...
    <div class="m7_t" id="confirm">
        ...
        <dl class="list_qna">
            ...
            <dt class="m1_t">どのような支払方法がありますか？</dt>
            <dd>クレジットカード（Visa、Master）、銀行振込（三菱UFJ銀行、ゆうちょ銀行、ジャパンネット銀行）からお選びいただけます。</dd>
            
            <dt class="m1_t">送料はいくらですか？</dt>
            <dd>1回のお申込につき、同一住所宛なら何枚でも200円です。3,000円以上のお買い上げで送料無料となります。</dd>
            
            <dt class="m1_t">後払いはできますか？</dt>
            <dd>「先払い」でお願いしていますが、図書館や学校法人などは、請求書による後払いも可能です。その場合はご相談ください。</dd>
            
            <dt class="m1_t">「団体・ライブラリー価格」とは何ですか？</dt>
            <dd>学校・団体や図書館など、不特定多数の方への無料貸出を目的としたご購入の場合は、「団体・ライブラリー価格」でお買い求め下さい。有料貸出の場合は、別途ご相談下さい。</dd>
            
            <dt class="m1_t">購入したDVDで、上映会を開催することはできますか？</dt>
            <dd>DVD・ブルーレイには上映権はついていません。上映をご希望の場合は、<a href="<?php echo get_permalink(get_page_by_path("four-walling")); ?>">こちら</a>をご覧ください。</dd>
            
            <dt class="m1_t">ディスクの規格は？</dt>
            <dd>DVDの規格は、NTSC、DVD-Rディスク（DVD-R対応機器にて再生可能）です。ブルーレイの規格は、NTSC、BD-Rディスク（BD-R対応機器にて再生可能）です。</dd>
            
            <dt class="m1_t">ディスクが再生されません。</dt>
