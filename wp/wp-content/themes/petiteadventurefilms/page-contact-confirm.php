...
<div class="m4_t">
<div class="col col_2">
	<form method="post" name="form" enctype="multipart/form-data" action="<?php echo get_permalink(get_page_by_path("contact")); ?>">
...
<div class="col col_2">
	<form method="post" name="form" enctype="multipart/form-data" action="<?php echo get_permalink(get_page_by_path("contact/thanks")); ?>">
		<?php foreach($_POST as $key => $value): ?>
			<input type="hidden" name="<?php echo $key; ?>" value="<?php echo $value; ?>">
		<?php endforeach; ?>
		<div class="form_btns">
			<div class="btn priority1"><input type="submit" value="問い合わせする" /></div>
		</div>
	</form>
</div>
<div class="last"></div>
