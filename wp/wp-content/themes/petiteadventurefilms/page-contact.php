...
<div class="col col_9 last">
	...
	<div class="m7_t">
		...
		<form method="post" name="form" enctype="multipart/form-data" action="<?php echo get_permalink(get_page_by_path("contact/confirm")); ?>" id="order">
			<?php include (TEMPLATEPATH . "/_contact_form.php"); ?>
			<div class="form_btns m4_t"><div class="btn priority1"><input type="submit" id="send" value="内容確認する" /></div></div>
		</form>
...
$(function(){
	...
	var jVal = {
		...
		"email" : function(d){
			...
			var msgId = eleId+"Msg";
			var msg = $("#"+msgId);
			var errorTypeMsg = "正しいメール形式ではありません hoge@example.com";
