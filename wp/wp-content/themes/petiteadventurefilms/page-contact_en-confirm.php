<?php
/*
Template Name: Contact EN Confrim
*/
...
<div class="m4_t">
<div class="col col_2">
	<form method="post" name="form" enctype="multipart/form-data" action="<?php echo get_permalink(get_page_by_path("contact_en")); ?>">
		<?php foreach($_POST as $key => $value): ?>
			<input type="hidden" name="<?php echo $key; ?>" value="<?php echo $value; ?>">
		<?php endforeach; ?>
		<div class="form_btns">
			<div class="btn priority2"><input type="submit" value="Back" onClick="history.back()" /></div>
		</div>
	</form>
</div>
<div class="col col_2">
	<form method="post" name="form" enctype="multipart/form-data" action="<?php echo get_permalink(get_page_by_path("contact_en/thanks")); ?>">
		<?php foreach($_POST as $key => $value): ?>
			<input type="hidden" name="<?php echo $key; ?>" value="<?php echo $value; ?>">
		<?php endforeach; ?>
		<div class="form_btns">
