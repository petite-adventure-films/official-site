...
<!-- 				<li<?php echo ($year[0]->slug == 2020) ? ' class="is_active"' : "";?>><a href="<?php echo get_permalink(get_page_by_path("events2020")); ?>">2020</a></li> -->
				<li<?php echo ($year[0]->slug == 2019) ? ' class="is_active"' : "";?>><a href="<?php echo get_permalink(get_page_by_path("events2019")); ?>">2019</a></li>
				<li<?php echo ($year[0]->slug == 2018) ? ' class="is_active"' : "";?>><a href="<?php echo get_permalink(get_page_by_path("events2018")); ?>">2018</a></li>
				<li<?php echo ($year[0]->slug == 2017) ? ' class="is_active"' : "";?>><a href="<?php echo get_permalink(get_page_by_path("events2017")); ?>">2017</a></li>
