    ...
    <div class="col col_9 last">
        ...
        <div class="greeting_director">
            ...
            <p>
                ...
                2013年、立ち退き裁判をたたかっていた当時の「住民の会」ホームページが、復刻版となって登場しました！<br>
                今回新たに、裁判後の情報も追加しました。UR団地の削減方針は、現在も維持されたままです。高幡台団地73号棟のたたかいが、全国で建て替え・取り壊し問題に直面する方々の取組に生かされることを願います！
            </p>
            <p class="al_r">
                2020年10月<br>
                プチ・アドベンチャー・フィルムズ<br>
        ...
        <section class="contents greeting_residents">
            ...
            v-for="(arr, key) in residents"
                ...
                <div class="__contents">
                    ...
                    <dl>
                        ...
                        <dt>ひとこと</dt><dd v-html="arr.message"></dd>
                    </dl>
                </div>
            </div>
        </div>
