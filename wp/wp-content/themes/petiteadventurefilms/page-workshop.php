...
<div class="col col_9 last">
	...
	<p class="m7_t">ビデオカメラが小型化し、値段も手ごろとなり、スマホでも簡単に動画が撮影できる時代になりました。それに伴い、「映像制作に興味がある」、「自分たちの活動を映像で紹介したい」、「スマホで撮った映像を編集したい」等々、映像制作を学びたい方が増えています。プチ・アドベンチャー・フィルムズでは、初心者～中級者を対象に、ニーズに合わせた映像ワークショップを承っております。ご興味のある方は、<a href="<?php echo get_permalink(get_page_by_path("contact_jp")); ?>">お問い合わせ</a>よりご連絡ください。</p>
	...
	<section class="contents">
		...
		<div class="col col_9 last">
			...
			※撮影の基礎から作品の公開までをひと通り学び、講座修了時までに3分間の映像作品を制作するコースの例は、<a href="http://www.petiteadventurefilms.com/201705_civil_ws/">こちら</a>をご覧ください。</small></p>
		</div>
	</section>
...
<div class="col col_9 last">
	...
	<section class="contents">
		...
		<dl class="list_definition">
			<dt>市民の学習・活動・交流センター シビル</dt><dd>2015年＆2017年 / 一般対象、全6回コース</dd>
