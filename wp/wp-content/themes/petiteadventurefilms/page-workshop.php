...
<div class="col col_9 last">
	...
	<p class="m7_t">ビデオカメラが小型化し、値段も手ごろとなり、スマホでも簡単に動画が撮影できる時代になりました。それに伴い、「映像制作に興味がある」、「自分たちの活動を映像で紹介したい」、「スマホで撮った映像を編集したい」等々、映像制作を学びたい方が増えています。プチ・アドベンチャー・フィルムズでは、初心者～中級者を対象に、ニーズに合わせた映像ワークショップを承っております。ご興味のある方は、以下「お問い合わせ」よりご連絡ください。</p>
